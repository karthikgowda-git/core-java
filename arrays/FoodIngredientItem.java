class FoodIngredientItem{
	public static String[] findIngredientsItemByFood(String foodName){
		System.out.println("Running findIngredientsItemByFood in FoodIngredientItem");
		
		System.out.println("Food Name:"+foodName);
		if(foodName == "Biriyani"){
			System.out.println("You have selected the Biriyani, Here are the ingredients to make biriyani");
			String[] biriyaniIngredients={"Oil","Ghee","Onion","Salt","Termeric","Tamoto","Spices","Rice","Chicken","Mint Leaves","Coriender Leaves"};
			...
			String[] friedRiceIngredients={"Oil","Onion","Chilly","Masala","Cabbage","Carrot","Beans","Egg","Rice","salt","Salt","CoreinderLeaves"};
